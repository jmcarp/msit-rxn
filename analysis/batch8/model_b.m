...
%                 spec{1}{condidx}.dur;
%         else
%             matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(condidx).duration = 0;
%         end
%         
%     end
%         
